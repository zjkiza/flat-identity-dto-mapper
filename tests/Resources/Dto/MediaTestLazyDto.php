...
final class MediaTestLazyDto implements \JsonSerializable
{
    #[Identifier]
    ...
    #[Collection(className: AuthorTestDto::class, columnPrefix: 'media_author_', naming: Naming::CamelToSnake, lazy: true)]
    public iterable|null $author = null;

    #[Collection(className: TagTestDto::class, columnPrefix: 'media_tag_', naming: Naming::CamelToSnake, lazy: true)]
